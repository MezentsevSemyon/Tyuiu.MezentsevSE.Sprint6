...
namespace Tyuiu.MezentsevSE.Sprint6.Task0.V26
{
    public partial class FormMain : Form
    {
        ...
        private void buttonRes_MSE_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                textBoxResult_MSE.Text = Convert.ToString(ds.Calculate(Convert.ToInt32(textBoxValue_MSE.Text)));
            }
            catch
            {
        ...
        private void textBoxValue_MSE_KeyPress(object sender, KeyPressEventArgs e)
        {
